...
bool Fournisseur::modifier_Fournisseur(int id_fournisseur,QString nom_Fournisseur,QString adresse_Fournisseur,QString matricule_fiscale)
{
    QSqlQuery query ;
QString res1   = QString::number(id_fournisseur);
  ...
  query.prepare("update fournisseurs set nom_fournisseur=:nom_Fournisseur,adresse_fournisseur=:adresse_Fournisseur,matricule_fiscale=:matricule_fiscale where id_fournisseur='"+res1+"'");
